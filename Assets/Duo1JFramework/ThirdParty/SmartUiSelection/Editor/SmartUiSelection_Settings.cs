...
namespace kamgam.editor.smartuiselection
{
    ...
    public class SmartUiSelection_Settings : ScriptableObject
    {
        ...
        public static void TurnAutoHideOff()
        {
            ...
            SmartUiSelection_AutoHide.ShowAllCanvases();
#endif
        ...
        private string _version = "3.3.0"; // semver of course
        ...
        [Header("Smart UI Selection - v3.3.0")]
        ...
        [Tooltip("If no ui element has been selected then try to click through the canvas and select 3D objects behind it. Works only for 3D objects with colliders.")]
        [SerializeField]
